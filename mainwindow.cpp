    ...
    ui(new Ui::MainWindow)
{
    ui->setupUi(this);
    libusb_init(NULL);
    device = libusb_open_device_with_vid_pid(NULL,1155,22797);
    if(device){
...
void MainWindow::on_writeButton_clicked()
{
    ...
    globalSettings .EffectGains[0] = ui->constantSlider_1->value();
    globalSettings .EffectGains[1] = ui->constantSlider_1->value();
    globalSettings .EffectGains[2] = ui->constantSlider_1->value();
    globalSettings .EffectGains[3] = ui->periodicSlider_1->value();
    globalSettings .EffectGains[4] = ui->periodicSlider_1->value();
    globalSettings .EffectGains[5] = ui->periodicSlider_1->value();
    globalSettings .EffectGains[6] = ui->periodicSlider_1->value();
    globalSettings .EffectGains[7] = ui->periodicSlider_1->value();
...
void MainWindow::on_readButton_clicked()
{
    ...
    ui->periodicSlider_1->setValue(globalSettings .EffectGains[3]);
